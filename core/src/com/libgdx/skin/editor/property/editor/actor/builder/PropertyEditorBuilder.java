	...
	public static class FloatBuilder extends PropertyEditorBuilder {
		...
		public Actor buildActor(CustomSkin projectSkin, Object styleObject, Field field, OnEditorCall onEditorCall) throws ReflectionException {
			...
			imageTextButton.addListener(new ChangeListener() {
				@Override
				public void changed(ChangeEvent event, Actor actor) {
					Stage stage = imageTextButton.getStage();
					String title = "Change Float Value";
					String fieldName = "Float Value:";
					String fieldValue = String.valueOf(value);
					TextFieldFilter textFieldFilter = new Dialogs.InputDialogFloatFilter();
					InputDialogListener inputDialogListener = new InputDialogListener() {
						...
						public void finished(String input) {
							...
							try {
								...
								Gdx.app.error("Change Float Dialog", "change float error", e);
								Dialogs.showOkDialog(stage, title + " Result", "error", GlobalData.skin);
							}
							onEditorCall.call();
						}
					};
					Dialogs.showInputDialog(stage, title, fieldName, fieldValue, projectSkin, textFieldFilter, inputDialogListener);
				}
			});
			return imageTextButton;
		}
